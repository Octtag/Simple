<?php
    class homeController{
        ...
        public function guardarUsuario($correo,$contraseña,$nombre,$apellido,$dni){
            $valor = $this->MODEL->agregarNuevoUsuario($this->limpiarcorreo($correo),$this->encriptarcontraseña($this->limpiarcadena($contraseña)), $this->limpiarcadena($nombre), $this->limpiarcadena($apellido), $this->limpiarcadena($dni));
            return $valor;
        }
